    ...
    <div class="container">
        <div class="email-wrapper">
            ...
            <div class="content">
                ...
                <p>Вы были зарегистрированы в системе электронного журнала как студент группы <strong>{{ $groupName }}</strong>.</p>
                ...
                <p style="color: #dc2626; font-weight: 500;">
                    Важно: После первого входа рекомендуем сменить пароль в личном кабинете!
                </p>
            </div>
